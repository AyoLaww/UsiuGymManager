      ...
      <CardContent className="flex flex-col gap-6">
        ...
        <form className="flex flex-col gap-10">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    >
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M13.875 18.825A10.05 10.05 0 0112 19c-5 0-9.27-3.11-10.5-7.5a10.05 10.05 0 012.563-4.568m2.1-2.1A9.956 9.956 0 0112 5c5 0 9.27 3.11 10.5 7.5a9.956 9.956 0 01-4.198 5.568M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
            ...
            <div className="flex flex-col gap-3">
                ...
                <Button type="button" variant="outline" className="w-full flex items-center justify-center gap-2 mt-2">
                    Sign Up
                </Button>
            </div>
